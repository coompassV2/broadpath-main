...
const CivitasSection = () => {
  return (
    <div id="civitas" className="min-h-screen bg-gradient-to-br from-slate-900 to-black flex items-center justify-start relative overflow-hidden">
      {/* Left Content Area */}
      <div className="px-8 lg:px-12 pt-8 lg:pt-12 z-10">
        <div className="max-w-4xl">
          ...
          <p className="lg:max-w-md text-white/70 font-light leading-relaxed text-lg mb-12">
            Transforming volunteer work into recognized academic credits while creating real impact.
          </p>
      ...
      <div className="absolute right-0 bottom-0">
        <div 
          ...
          style={{
            backgroundImage: `url('/lovable-uploads/fafbd7d9-4ae9-4979-af28-b4d09f42fe25.png')`
          }}
        >
